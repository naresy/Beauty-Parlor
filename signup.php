...
<html lang="en">
  <head>
    ...
    <title>Sandy's Threading | Signup Page</title>
...
?>
                    <div class="cont-top">
                        ...
                        <div class="cont-right">
                            <h6>Call Us</h6>
                            <p class="para"><a href="(909)712-2101">+<?php  echo $row['MobileNumber'];?></a></p>
                        </div>
                    </div>
                ...
                <div class="map-content-9 mt-lg-0 mt-4">
                    ...
                    <form method="post" name="signup" onsubmit="return checkpass();">
                        ...
                        <div style="padding-top: 5px;">
                           ...
                           <input type="text" class="form-control" placeholder="Mobile Number"  name="mobilenumber" pattern="[0-9]+" maxlength="10"></div>
                           <div style="padding-top: 5px;">
